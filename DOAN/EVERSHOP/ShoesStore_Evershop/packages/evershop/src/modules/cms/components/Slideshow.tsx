...
export default function Slideshow(props: any) {
  ...
  // Handle both direct props and nested slideshowWidget prop
  const slideshowWidget = props.slideshowWidget || props;

  // Guard against null/undefined slideshowWidget
  if (!slideshowWidget || typeof slideshowWidget !== 'object') {
    return null;
  }
  ...
  return (
    <div className={containerClasses} style={containerStyle}>
      <SliderComponent {...settings} style={sliderStyle}>
        {slides.map((slide) => {
          // Guard against slides with missing image
