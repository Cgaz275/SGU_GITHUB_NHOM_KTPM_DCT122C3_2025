...
export default function BasicMenu(props: any) {
  ...
  // Handle both direct props and nested basicMenuWidget prop
  const basicMenuWidget = props.basicMenuWidget || props;

  // Guard against null/undefined basicMenuWidget
  if (!basicMenuWidget || typeof basicMenuWidget !== 'object' || !basicMenuWidget.menus) {
    return null;
  }

  const { menus, isMain = false, className = '' } = basicMenuWidget;
